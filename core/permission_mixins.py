...
class PermissionConfigMixin:
    ...
    def get_permissions(self):
        ...
        permission_config = get_permission_classes_for_viewset(
            self.app_name, 
            self.viewset_name
        )
...
class SkillPermissionMixin:
    ...
    def get_permissions(self):
        ...
        if self.action in ['create', 'update', 'partial_update', 'destroy']:
            ...
            if 'Skill' in self.__class__.__name__ and 'Job' not in self.__class__.__name__ and 'User' not in self.__class__.__name__:
