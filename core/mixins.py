...
class StandardResponseMixin:
    ...
    def create(self, request, *args, **kwargs):
        ...
        return APIResponse.created(
            ...
            message=f"{self.get_verbose_name()} created successfully"
        )
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        return APIResponse.success(
            ...
            message=f"{self.get_verbose_name()} retrieved successfully"
        )
    ...
    def update(self, request, *args, **kwargs):
        ...
        return APIResponse.success(
            data=serializer.data,
            message=f"{self.get_verbose_name()} updated successfully"
        )
    ...
    def list(self, request, *args, **kwargs):
        ...
        if page is not None:
            ...
            return APIResponse.success(
                ...
                message=f"{self.get_verbose_name_plural()} retrieved successfully"
            )
