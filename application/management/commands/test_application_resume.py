...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if options['test_backward_compatibility']:
            ...
            self.stdout.write(
                self.style.ERROR('Please specify --test-backward-compatibility or --test-enhanced-resume')
            )
    ...
    def test_enhanced_resume(self):
        ...
        application = Application.objects.create(
            job=job,
            user=user,
            cover_letter="Test cover letter with auto resume"
        )
    ...
    def create_test_data(self):
        ...
        city, created = City.objects.get_or_create(
            name='Test City for Applications',
