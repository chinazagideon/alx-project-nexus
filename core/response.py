...
class ValidationErrorResponseSerializer(serializers.Serializer):
    ...
    errors = serializers.DictField(
        child=serializers.ListField(child=serializers.CharField()), help_text="Validation errors by field"
    )
...
def create_success_response_serializer(data_serializer=None, message="Request completed successfully", status_code=200):
    ...
    code = status_code
    data_field = (
        data_serializer if data_serializer else serializers.JSONField(help_text="Response data payload", allow_null=True)
    )
...
class APIResponse:
    ...
    @staticmethod
    def success(
        data: Any = None, message: str = "Request completed successfully", status_code: int = status.HTTP_200_OK, **kwargs
    ) -> Response:
        """
    ...
    @staticmethod
    def created(data: Any = None, message: str = "Resource created successfully", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.success(data=data, message=message, status_code=status.HTTP_201_CREATED, **kwargs)

    @staticmethod
    def no_content(message: str = "Request completed successfully", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.success(data=None, message=message, status_code=status.HTTP_204_NO_CONTENT, **kwargs)
    ...
    @staticmethod
    def validation_error(errors: Dict, message: str = "Validation failed", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.error(message=message, errors=errors, status_code=status.HTTP_400_BAD_REQUEST, **kwargs)

    @staticmethod
    def not_found(message: str = "Resource not found", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.error(message=message, status_code=status.HTTP_404_NOT_FOUND, **kwargs)

    @staticmethod
    def unauthorized(message: str = "Authentication required", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.error(message=message, status_code=status.HTTP_401_UNAUTHORIZED, **kwargs)

    @staticmethod
    def forbidden(message: str = "Permission denied", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.error(message=message, status_code=status.HTTP_403_FORBIDDEN, **kwargs)

    @staticmethod
    def server_error(message: str = "Internal server error", **kwargs) -> Response:
        """
        ...
        """
        return APIResponse.error(message=message, status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, **kwargs)
        ...
        def wrapper(self, request, *args, **kwargs):
            try:
                ...
                return APIResponse.error(
                    message=f"An error occurred: {str(e)}", status_code=status.HTTP_500_INTERNAL_SERVER_ERROR
                )
