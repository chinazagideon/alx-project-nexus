    ...
    def handle(self, *args, **options):
        ...
        for model_path in models_to_export:
            try:
                ...
                self.stdout.write(self.style.ERROR(f"Error exporting {model_path}: {str(e)}"))

        self.stdout.write(self.style.SUCCESS(f"Data export completed! Files saved to {output_dir}"))
