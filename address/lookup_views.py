...
def get_cities_by_state(request):
    ...
    if not state_id:
        return Response({"error": "state_id parameter is required"}, status=status.HTTP_400_BAD_REQUEST)
...
@extend_schema(
    ...
    parameters=[
        OpenApiParameter(
            name="q", type=OpenApiTypes.STR, location=OpenApiParameter.QUERY, description="Search query", required=True
        ),
        OpenApiParameter(
            name="limit",
            type=OpenApiTypes.INT,
        ...
        200: {
            ...
            "properties": {
                ...
                "cities": {
                    ...
                    "items": {
                        "type": "object",
                        "properties": {"id": {"type": "integer"}, "name": {"type": "string"}, "state_id": {"type": "integer"}},
                    },
                },
            },
        }
