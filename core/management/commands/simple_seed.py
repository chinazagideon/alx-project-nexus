...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Simple data seeding completed!"))
    ...
    def create_basic_skills(self):
        ...
        for skill_name in skills:
            Skill.objects.get_or_create(name=skill_name, defaults={"status": True})
    ...
    def create_basic_locations(self):
        ...
        for country_data in countries_data:
            country, created = Country.objects.get_or_create(
                code=country_data["code"], defaults={"name": country_data["name"]}
            )
        ...
        for state_data in states_data:
            state, created = State.objects.get_or_create(name=state_data["name"], country=countries[state_data["country"]])
        ...
        for city_data in cities_data:
            city, created = City.objects.get_or_create(name=city_data["name"], state=states[city_data["state"]])
